...
gmail_channel_oauth_router = APIRouter(prefix="/gmail/oauth", tags=["oauth"])
...
@gmail_channel_oauth_router.post("/initialize/{project_id}")
...
@gmail_channel_oauth_router.post("/refresh")
...
@gmail_channel_oauth_router.get("/callback")
